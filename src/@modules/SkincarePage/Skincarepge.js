...
import classes from "./SkincarePage.module.css";
import ProductCard from "../../@components/ProductCard/ProductCard";

function Skincarepge() {
  ...
  useEffect(() => {
    dispatch(getProductsByCategory("Skincare"));
  }, [dispatch]);
  return (
    <>
      {productsLoading ? (
        ...
        <div className={classes.skincarepageContainer}>
          {productsData &&
